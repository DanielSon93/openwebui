...
var file = "node_modules/@sveltejs/svelte-virtual-list/VirtualList.svelte";
function add_css(target) {
  append_styles(target, "svelte-1tqh76q", "svelte-virtual-list-viewport.svelte-1tqh76q{position:relative;overflow-y:auto;-webkit-overflow-scrolling:touch;display:block}svelte-virtual-list-contents.svelte-1tqh76q,svelte-virtual-list-row.svelte-1tqh76q{display:block}svelte-virtual-list-row.svelte-1tqh76q{overflow:hidden}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_each_block(key_1, ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(svelte_virtual_list_row, file, 164, 3, 3469);
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(svelte_virtual_list_contents, file, 159, 1, 3313);
      set_style(
      ...
      add_location(svelte_virtual_list_viewport, file, 153, 0, 3167);
    },
    m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("height" in $$props2) $$invalidate(0, height = $$props2.height);
    if ("itemHeight" in $$props2) $$invalidate(11, itemHeight = $$props2.itemHeight);
    if ("foo" in $$props2) foo = $$props2.foo;
    if ("start" in $$props2) $$invalidate(8, start = $$props2.start);
    if ("end" in $$props2) $$invalidate(9, end = $$props2.end);
    if ("height_map" in $$props2) height_map = $$props2.height_map;
    if ("rows" in $$props2) rows = $$props2.rows;
    if ("viewport" in $$props2) $$invalidate(2, viewport = $$props2.viewport);
    if ("contents" in $$props2) $$invalidate(3, contents = $$props2.contents);
    if ("viewport_height" in $$props2) $$invalidate(1, viewport_height = $$props2.viewport_height);
    if ("visible" in $$props2) $$invalidate(4, visible = $$props2.visible);
    if ("mounted" in $$props2) $$invalidate(12, mounted = $$props2.mounted);
    if ("top" in $$props2) $$invalidate(5, top = $$props2.top);
    if ("bottom" in $$props2) $$invalidate(6, bottom = $$props2.bottom);
    if ("average_height" in $$props2) average_height = $$props2.average_height;
  };
