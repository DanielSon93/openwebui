...
var Un = ((e) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(e, { get: (t, r) => (typeof __require < "u" ? __require : t)[r] }) : e)(function(e) {
...
var aa = U(() => {
  ...
  oa = (e, t) => {
    ...
    if (n != null) {
      ...
      let a = (t == null ? void 0 : t.format) !== void 0 ? t.format : "RGB", d = t == null ? void 0 : t.norm, l, p;
    ...
    if (r != null) {
      ...
      let d = t !== void 0 && t.format !== void 0 ? t.format : "RGB", l = t == null ? void 0 : t.norm, p, m;
...
var Ea = U(() => {
  ...
  gt();
  $r();
  Ca = "ort-wasm-proxy-worker", Aa = ((_a2 = globalThis.self) == null ? void 0 : _a2.name) === Ca;
  Aa && (self.onmessage = (e) => {
...
var Oa = U(() => {
  ...
  Pa = (qn = import.meta.url, async function(e = {}) {
    ...
    let $ = () => {
      let s = (f, b, w) => (...I) => {
        let O = Xe, B = b == null ? void 0 : b();
        I = f(...I);
        let G = b == null ? void 0 : b();
        ...
        try {
          ...
          (_a3 = u.Hb) == null ? void 0 : _a3.flush();
          let O = w.errors;
          if (0 < O.length) {
...
`));
    ...
    var Ie = [], He = [], mn = [], wt = 0, fn = null, Gt = null;
    function Oo() {
      if (--wt == 0 && (fn !== null && (clearInterval(fn), fn = null), Gt)) {
        var s = Gt;
        Gt = null, s();
      }
    }
    ...
    function Fo() {
      var s = new Worker(import.meta.url.startsWith("file:") ? new URL("ort.bundle.min.mjs", import.meta.url) : new URL(import.meta.url), { type: "module", workerData: "em-pthread", name: "em-pthread" });
      pt.push(s);
    }
    var nr = (s) => {
    ...
    function st(s, c, f = {}) {
      ...
      return function(b, w, I = {}) {
        ...
        xn[b] = w, delete Ac[b], $n.hasOwnProperty(b) && (w = $n[b], delete $n[b], w.forEach((B) => B()));
      }(s, c, f);
    }
    var ci = (s, c, f) => {
      switch (c) {
    ...
    var pi = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, Uc = (s, c) => {
      ...
      if (c >>>= 0, f ?? (f = 2147483647), 4 > f) return 0;
      var b = c;
      f = b + f - 4;
...
`, "%p": (z) => 0 <= z.Ib && 12 > z.Ib ? "AM" : "PM", "%S": (z) => I(z.lc, 2), "%t": () => "	", "%u": (z) => z.vb || 7, "%U": (z) => I(Math.floor((z.Cb + 7 - z.vb) / 7), 2), "%V": (z) => {
    ...
    var Np = [_n, Vo, qo, Zo, Qo, Jo, ei, ti, ri, ni, oi, ii, ai, si, ui, di, xi, Si, ki, Ei, Pi, zi, Oi, Di], Z = function() {
      ...
      return hn || (hn = u.locateFile ? Do("ort-wasm-simd-threaded.jsep.wasm") ? "ort-wasm-simd-threaded.jsep.wasm" : u.locateFile ? u.locateFile("ort-wasm-simd-threaded.jsep.wasm", C) : C + "ort-wasm-simd-threaded.jsep.wasm" : new URL("ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href), function(f, b) {
        var w = hn;
  ...
  ((_a2 = globalThis.self) == null ? void 0 : _a2.name) === "em-pthread" && Pa();
});
var Ma;
var jp;
var Ve;
...
var $r = U(() => {
  ...
  Ma = typeof location > "u" ? void 0 : location.origin, jp = () => {
    var _a2;
    if (true) return ((_a2 = import.meta.url) == null ? void 0 : _a2.startsWith("file:")) ? new URL(new URL("ort.bundle.min.mjs", import.meta.url).href, Ma).href : import.meta.url;
  }, Ve = jp(), Ra = () => {
...
var gt = U(() => {
  ...
  Yn = false, Pr = false, Wa = false, Xp = () => {
    ...
    let o = e.wasmPaths, i = typeof o == "string" ? o : void 0, a = o == null ? void 0 : o.mjs, d = (a == null ? void 0 : a.href) ?? a, l = o == null ? void 0 : o.wasm, p = (l == null ? void 0 : l.href) ?? l, m = e.wasmBinary, [u, h] = await Va(d, i, r > 1), _ = false, y = [];
...
var Ga = U(() => {
  ...
  La = (e) => {
    ...
    try {
      ...
      let i = 0;
      return (e == null ? void 0 : e.tag) !== void 0 && (i = ke(e.tag, n)), r = t._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), r === 0 && ce("Can't create run options."), (e == null ? void 0 : e.extra) !== void 0 && Kt(e.extra, "", /* @__PURE__ */ new WeakSet(), (a, d) => {
      ...
      switch (o) {
        case "webnn":
          if (o = "WEBNN", typeof n != "string") {
            let d = n == null ? void 0 : n.deviceType;
            if (d) {
        ...
        case "webgpu":
          if (o = "JS", typeof n != "string") {
            let a = n;
            if (a == null ? void 0 : a.preferredLayout) {
...
var Qn = U(() => {
  ...
  Zt = async (e) => {
    if (typeof e == "string") if (false) try {
      let { readFile: t } = Un("node:fs/promises");
      return new Uint8Array(await t(e));
    } catch (t) {
      if (t.code === "ERR_FS_FILE_TOO_LARGE") {
        let { createReadStream: r } = Un("node:fs"), n = r(e), o = [];
...
var yt = U(() => {
  ...
  Ke = (e, t, r = "f32") => {
    ...
    if (t === "HardSigmoid") {
      ...
      let [r, n] = (e == null ? void 0 : e.activation_params) || [Ja, es];
...
var Fu = U(() => {
  ...
  lf = (e) => {
    ...
    let a = i === "channelsLast", d = a ? e[0].dims[3] : e[0].dims[1], l = false, p = [64, 1, 1], m = { x: r.map((v, S) => S) }, u = [Math.ceil(lf(m.x.map((v) => r[v])) / p[0]), 1, 1];
    se("verbose", () => `[conv3d_naive_webgpu] dispatch = ${u}`);
    let h = l ? a && d % 4 !== 0 ? 3 : 4 : 1, _ = k.size(r), y = [{ type: 12, data: _ }, { type: 12, data: n }, { type: 12, data: o }, { type: 12, data: t.strides }, { type: 12, data: t.dilations }];
    ...
    let $ = (v) => {
      ...
      Ye(t, S);
      let T = l ? 4 : 1, A = ye(e[0].dataType), C = E("x", e[0].dataType, e[0].dims.length, h === 3 ? 1 : h), P = E("W", e[1].dataType, e[1].dims.length, T), D = [C, P], R = M("result", e[0].dataType, r.length, T), H = "";
      if (x) {
...
var fd = U(() => {
  ...
  wo = "[a-zA-Z]|\\.\\.\\.", Jr = "(" + wo + ")+", ld = "^" + Jr + "$", If = "(" + Jr + ",)*" + Jr, Cf = "^" + If + "$", vo = class {
    ...
    constructor(t, r) {
      ...
      (_a2 = o.match(RegExp(wo, "g"))) == null ? void 0 : _a2.forEach((d) => {
    ...
    processTerm(t, r, n, o = -1) {
      ...
      return p == null ? void 0 : p.forEach((u, h) => {
        if (u === "...") {
    ...
    let i = e.map((m) => m.length).map((m, u) => E(`input${u}`, t, m)), a = k.size(n), d = M("output", t, n.length), l = [...r.symbolToInfo.keys()].filter((m) => !r.rhs.symbolToIndices.has(m)), p = (m) => {
      ...
      r.symbolToInfo.forEach((A, C) => {
        ...
        if (r.rhs.symbolToIndices.has(C)) {
          let P = (_a2 = r.rhs.symbolToIndices.get(C)) == null ? void 0 : _a2[0];
...
`)};
    ...
    return { name: "Einsum", shaderCache: { hint: r.equation, inputDependencies: e.map(() => "rank") }, getRunData: () => {
      let m = l.filter((h) => r.symbolToInfo.has(h)).map((h) => {
        var _a2;
        return { type: 12, data: ((_a2 = r.symbolToInfo.get(h)) == null ? void 0 : _a2.dimValue) || 0 };
      });
...
` : "", Lh = (e, t, r, n, o) => {
    ...
    let m = r.length === 2, u = true, [h, _] = m ? [0, 1] : u ? [2, 3] : [1, 2], y = e.type.value, g = (x) => {
      let $ = x === h ? "row" : "col";
      return `
...
var Jl = U(() => {
  ...
  ug = (e, t) => {
    ...
    var _a2, _b;
    let n = e.name;
    return ((_a2 = e.shaderCache) == null ? void 0 : _a2.hint) && (n += "[" + e.shaderCache.hint + "]"), n += ":" + r + `:${ug(t, ((_b = e.shaderCache) == null ? void 0 : _b.inputDependencies) ?? new Array(t.length).fill("dims"))}`, n;
  }, Io = class {
    constructor(t) {
    ...
    flush() {
      ...
      this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), t = this.device.createBuffer({ size: this.pendingDispatchNumber * 2 * 8, usage: GPUBufferUsage.MAP_READ | GPUBufferUsage.COPY_DST }), this.pendingQueries.set(t, this.pendingKernels), this.pendingKernels = [], this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer, 0, t, 0, this.pendingDispatchNumber * 2 * 8)), this.device.queue.submit([this.commandEncoder.finish()]), this.gpuDataManager.refreshPendingBuffers(), this.commandEncoder = null, this.pendingDispatchNumber = 0, this.queryType !== "none" && t.mapAsync(GPUMapMode.READ).then(() => {
        ...
        for (let o = 0; o < r.length / 2; o++) {
          ...
          if ((_a2 = this.env.webgpu.profiling) == null ? void 0 : _a2.ondata) this.env.webgpu.profiling.ondata({ version: 1, inputsMetadata: u.map(($) => ({ dims: $.dims, dataType: bt($.dataType) })), outputsMetadata: h.map(($) => ({ dims: $.dims, dataType: bt($.dataType) })), kernelId: a, kernelType: l, kernelName: p, programName: m, startTime: g, endTime: x });
          else {
            let $ = "";
            u.forEach((S, T) => {
...
var nc = U(() => {
  ...
  lg = 1, ec = () => lg++, cg = /* @__PURE__ */ new Map([["float32", 32], ["float16", 16], ["int32", 32], ["uint32", 32], ["int64", 64], ["uint64", 64], ["int8", 8], ["uint8", 8], ["int4", 4], ["uint4", 4]]), tc = (e, t) => {
    ...
    async download(t, r) {
      se("verbose", () => `[WebNN] TensorManager.download {tensorId: ${t}, dstBuffer: ${r == null ? void 0 : r.byteLength}}`);
      let n = this.tensorTrackersById.get(t);
      if (!n) throw new Error("Tensor not found.");
      return n.download(r);
    }
...
var sc = U(() => {
  ...
  tr = class e {
    ...
    compute(t, r) {
      var _a2;
      let n = ((_a2 = r == null ? void 0 : r.inputs) == null ? void 0 : _a2.map((d) => typeof d == "number" ? this.inputs[d] : d)) ?? this.inputs, o = (r == null ? void 0 : r.outputs) ?? [], i = (d, l, p) => new tr(this.module, l, this.output(d, p), p), a = (d, l) => {
        let p = At(d, l);
...
var Fn = U(() => {
  ...
  fg = (e, t) => {
    ...
    try {
      if ([a, l] = Ha(t), (t == null ? void 0 : t.externalData) && o.mountExternalData) {
        let v = [];
      ...
      for (let v of (t == null ? void 0 : t.executionProviders) ?? []) if ((typeof v == "string" ? v : v.name) === "webnn") {
        if (o.shouldTransferToMLTensor = false, typeof v != "string") {
          let T = v, A = T == null ? void 0 : T.context, C = T == null ? void 0 : T.gpuDevice, P = T == null ? void 0 : T.deviceType, D = T == null ? void 0 : T.powerPreference;
      ...
      i = await o._OrtCreateSession(r, n, a), i === 0 && ce("Can't create a session."), (_a2 = o.jsepOnCreateSession) == null ? void 0 : _a2.call(o), o.currentContext && (o.jsepRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = true);
      let [u, h] = hg(i), _ = !!(t == null ? void 0 : t.enableGraphCapture), y = [], g = [], x = [];
      for (let v = 0; v < u; v++) {
      ...
      for (let v = 0; v < h; v++) {
        ...
        g.push(T);
        {
          ...
          let A = typeof (t == null ? void 0 : t.preferredOutputLocation) == "string" ? t.preferredOutputLocation : ((_b = t == null ? void 0 : t.preferredOutputLocation) == null ? void 0 : _b[T]) ?? "cpu";
      ...
      o._free(r), a !== 0 && o._OrtReleaseSessionOptions(a) !== 0 && ce("Can't release session options."), l.forEach((u) => o._free(u)), (_c2 = o.unmountExternalData) == null ? void 0 : _c2.call(o);
    }
  }, Cr = (e) => {
    var _a2;
    let t = Te(), r = zt.get(e);
    ...
    let [n, o, i, a, d] = r;
    a && (d && t._OrtClearBoundOutputs(a.handle) !== 0 && ce("Can't clear bound outputs."), t._OrtReleaseBinding(a.handle) !== 0 && ce("Can't release IO binding.")), (_a2 = t.jsepOnReleaseSession) == null ? void 0 : _a2.call(t, e), o.forEach((l) => t._OrtFree(l)), i.forEach((l) => t._OrtFree(l)), t._OrtReleaseSession(n) !== 0 && ce("Can't release session."), zt.delete(e);
    ...
    try {
      (_a2 = a.jsepOnRunStart) == null ? void 0 : _a2.call(a, p), [$, v] = La(i);
      ...
      if (h && !y) {
        ...
        for (let j = 0; j < x; j++) {
          let Q = n[j];
          ((_b = o[j]) == null ? void 0 : _b[3]) ? a._OrtBindOutput(V, u[Q], T[j], 0) !== 0 && ce(`Can't bind pre-allocated output[${j}] for session=${e}.`) : a._OrtBindOutput(V, u[Q], 0, we[Q]) !== 0 && ce(`Can't bind output[${j}] to ${K[j]} for session=${e}.`);
        }
      ...
      for (let V = 0; V < x; V++) {
        ...
        try {
          ...
          ie = bt(ve);
          let De = h == null ? void 0 : h.outputPreferredLocations[n[V]];
          if (ie === "string") {
  ...
  Ot = () => !!_e.wasm.proxy && typeof document < "u", rr = false, dn = false, ln = false, Po = /* @__PURE__ */ new Map(), Wt = (e, t) => {
    ...
    if (!dn) {
      ...
      if (rr = true, Ot()) return new Promise((e, t) => {
        Ge == null ? void 0 : Ge.terminate(), Na().then(([r, n]) => {
          var _a2;
          try {
            Ge = n, Ge.onerror = (i) => t(i), Ge.onmessage = bg, Eo = [e, t];
            let o = { type: "init-wasm", in: _e };
            !o.in.wasm.wasmPaths && (r || ((_a2 = import.meta.url) == null ? void 0 : _a2.startsWith("file:"))) && (o.in.wasm.wasmPaths = { wasm: new URL("ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href }), Ge.postMessage(o), un = r;
          } catch (o) {
            t(o);
          }
        }, t);
...
var bc = U(() => {
  ...
  gc = (e, t) => {
    ...
    async loadModel(t, r) {
      Ne();
      let n;
      typeof t == "string" ? false ? n = await Zt(t) : n = await this.fetchModelAndCopyToWasmMemory(t) : n = t, [this.sessionId, this.inputNames, this.outputNames] = await pc(n, r), Be();
    }
    async dispose() {
