...
var hasKatex = __name((text) => {
  var _a8;
  return (((_a8 = text.match(katexRegex)) == null ? void 0 : _a8.length) ?? 0) > 0;
}, "hasKatex");
...
var renderKatex = __name(async (text, config2) => {
  if (!hasKatex(text)) {
    return text;
  }
...
function line_default(x3, y3) {
  ...
  line.y = function(_) {
    return arguments.length ? (y3 = typeof _ === "function" ? _ : constant_default(+_), line) : y3;
  };
...
function clipAntimeridianInterpolate(from, to, direction, stream) {
  ...
  if (from == null) {
    ...
    stream.point(-pi4, 0);
    stream.point(-pi4, phi2);
  } else if (abs4(from[0] - to[0]) > epsilon6) {
...
function mercatorRaw(lambda, phi2) {
  return [lambda, log4(tan((halfPi3 + phi2) / 2))];
}
...
function transverseMercatorRaw(lambda, phi2) {
  return [log4(tan((halfPi3 + phi2) / 2)), -lambda];
}
...
//# sourceMappingURL=chunk-2JSYDFN4.js.map
